...
---------------------------------------------------------------------- */
#ifndef __HTU21D_FUNCTION__
#define __HTU21D_FUNCTION__  
...
CHAR8S HTU21D_READ_TEMPERATURE(FLOAT *t,CHAR8U mode)
{
		...
		/* check mode */
		if(mode !=HTU21D_MODE0  && mode !=HTU21D_MODE1 && mode !=HTU21D_MODE2 &&mode !=HTU21D_MODE3  )return -1;	/*error mode value*/
